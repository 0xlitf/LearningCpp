...
public:
    ...
    inline static const char* vertexShaderSource = "attribute highp vec4 posAttr;\n"
    ...
    inline static const char* fragmentShaderSource = "varying lowp vec4 col;\n"
                                              "void main() {\n"
                                              "   gl_FragColor = col;\n"
                                              "}\n";
